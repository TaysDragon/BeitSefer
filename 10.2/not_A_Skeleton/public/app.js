...
$("#weightsort").on("click", function(event) {
...
$("#namesort").on("click", function(event) {
            event.preventDefault();  //only needed for form submit buttons which have a default action.  Normal buttons do not have a default function.

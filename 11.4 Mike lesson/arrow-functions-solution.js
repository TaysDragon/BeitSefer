...
const createNewUser = (name,attack)=>{
    var name = name;  //can be removed, taken from above
    var attack = attack;  //can be removed, taken from above
    const newUserObj = {
        name:name,
        attack:attack,
...
let bob = createNewUser("bob",47);  //new would throw an error, compare to activity
// can't use new if you are using =>

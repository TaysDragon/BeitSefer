...
//for color vs colors, use single instead of plurarl is correct convention standards even though you could name it whatever
...
let lostValues = ["health","hope","happiness"];

let healthy = lostValues.find(function(value){
    return value === "health";
});
console.log(healthy); //returns ["health"];
...
//cannot use array helper with a generator function